...
public class NewGameResultHistoryFragment extends NewHistoryItemListFragment {
	...
	protected View inflate(LayoutInflater inflater) {
		return inflater.inflate(
				R.layout.new_history_game_result_history_fragment, null);
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new HistoryListAdapter(getActivity(),
				R.layout.new_history_game_result_history_list_item);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView.setMultiChoiceModeListener(new MultiChoiceModeListener() {
			...
			public boolean onCreateActionMode(ActionMode mode, Menu menu) {
				...
				inflater.inflate(R.menu.context_result_history, menu);
				return true;
			}
